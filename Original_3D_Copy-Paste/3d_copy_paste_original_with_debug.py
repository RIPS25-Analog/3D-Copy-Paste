...
def load_insert_object(filepath):
    ...
    print(f"Imported object name: {inobject.name}")
...
if __name__ == '__main__':
    ...
    parser.add_argument('--root_path', default="/home/coraguo/RIPS25-AnalogDevices-ObjectDetection/src/3d_C_P/mmdetection3d/data/sunrgbd/sunrgbd_trainval", help='root path for SUN RGB-D data')
    parser.add_argument('--obj_root_path', default="/home/coraguo/RIPS25-AnalogDevices-ObjectDetection/src/3d_C_P/objaverse/obj", help='root path for Objaverse data')
    ...
    parser.add_argument('--max_iter', type=int, default=3, help='number of inserted objects for each scene')
    parser.add_argument('--random_seed', type=int, default=1, help='random seed for reproduce')
    parser.add_argument('--resize_factor', type=int, default=1, help='to shrink the size of the inserted object to handle inserting a large object in a small empty floor scenario')
